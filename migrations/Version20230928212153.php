 ...
 */
final class Version20230928212153 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE current_challenge (id INT AUTO_INCREMENT NOT NULL, challenge_id_id INT NOT NULL, user_uuid_id INT NOT NULL, user_id VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, points INT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_C2F38FD7B961745 (challenge_id_id), INDEX IDX_C2F38FD99B8CBC0 (user_uuid_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
