 ...
 */
final class Version20230928130227 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE challenge (id INT NOT NULL, created_by_id INT DEFAULT NULL, uuid UUID NOT NULL, title VARCHAR(600) NOT NULL, description VARCHAR(255) NOT NULL, status VARCHAR(3000) NOT NULL, category VARCHAR(255) NOT NULL, subcategory VARCHAR(255) NOT NULL, points INT NOT NULL, duration INT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP, tips VARCHAR(3000) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE current_challenge (id INT NOT NULL, user_uuid_id INT NOT NULL, challenge_id_id INT NOT NULL, user_id VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, points INT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
